...
class GetData(object):
    ...
    def __init__(self, server_auto_id, server_user_id):
        self.ret = {}
...
if __name__ == '__main__':
    getdata = GetData(sys.argv[1], sys.argv[2]).send_data()
send_data(url='http://192.168.17.1:8000/resources/server/data_api/', data=json.dumps(getdata))
